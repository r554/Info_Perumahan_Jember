      ...
      <div class="card-body">
        <table border="0">
          <tr>
            ...
            <td>
              <a href="?page=edit_akun&?kd_admin=<?php echo $fetch['kd_admin'] ?>" class="btn btn-info btn-xs">
          ...
          <tr>
            ...
            <td>:</td>
            <td></td>
            <td><input type="password" value="<?php echo $fetch['admin_password']; ?>" readonly disabled></td>
          </tr>
          <tr>
            <td>No Telpon</td>
            <td></td>
