                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password_dev" value="<?php echo $fetch['password_dev']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <input type="submit" name="kirim" value="Terima" style="width: 100%;" class="btn btn-info">
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                            </div>
