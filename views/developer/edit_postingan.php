                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="judul_postingan" value="<?php echo $r['judul_postingan']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Tipe Rumah</label><br>
                                        <input type="text" name="tipe_rumah" value="<?php echo $r['tipe_rumah']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Jumlah Unit</label><br>
                                        <input type="text" name="jumlah_unit_rumah" value="<?php echo $r['jumlah_unit_rumah']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Harga Kisaran</label><br>
                                        <input type="text" name="harga" value="<?php echo $r['harga']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <img src="img/postingan/<?php echo $r['foto_1']; ?>" width="300px" height="300px" style="width: 100%;">
                                        <input type="file" name="foto_1">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Foto Tampak Belakang</label><br>
                                        <img src="img/postingan/<?php echo $r['foto_2']; ?>" width="300px" height="300px" style="width: 100%;">
                                        <input type="file" name="foto_2">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Foto Tampak Dalam</label><br>
                                        <img src="img/postingan/<?php echo $r['foto_3']; ?>" width="300px" height="300px" style="width: 100%;">
                                        <input type="file" name="foto_3">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Foto Dapur</label><br>
                                        <img src="img/postingan/<?php echo $r['foto_4']; ?>" width="300px" height="300px" style="width: 100%;">
                                        <input type="file" name="foto_4">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Foto Kamat Tidur</label><br>
                                        <img src="img/postingan/<?php echo $r['foto_5']; ?>" width="300px" height="300px" style="width: 100%;">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="luas_tanah" value="<?php echo $r['luas_tanah']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Luas Bangunan</label><br>
                                        <input type="text" name="luas_bangunan" value="<?php echo $r['luas_bangunan']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Jumlah Kamar Tidur</label><br>
                                        <input type="text" name="jumlah_kamar" value="<?php echo $r['jumlah_kamar']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Jumlah Kamar Mandi</label><br>
                                        <input type="text" name="jumlah_wc" value="<?php echo $r['jumlah_wc']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Sumber Air</label><br>
                                        <input type="text" name="sumber_air" value="<?php echo $r['sumber_air']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Daya Listrik</label><br>
                                        <input type="text" name="daya_listrik" value="<?php echo $r['daya_listrik']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Pondasi Rumah</label><br>
                                        <input type="text" name="pondasi" value="<?php echo $r['pondasi']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Dinding Rumah</label><br>
                                        <input type="text" name="dinding" value="<?php echo $r['dinding']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Daun Pintu</label><br>
                                        <input type="text" name="daun_pintu" value="<?php echo $r['daun_pintu']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Kusen</label><br>
                                        <input type="text" name="kusen" value="<?php echo $r['kusen']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Ukuran Keramik</label><br>
                                        <input type="text" name="keramik" value="<?php echo $r['keramik']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Pintu Kamar Mandi</label><br>
                                        <input type="text" name="pintu_km_mandi" value="<?php echo $r['pintu_km_mandi']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Kerangka Atap</label><br>
                                        <input type="text" name="kerangka_atap" value="<?php echo $r['kerangka_atap']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Rangka Plafon</label><br>
                                        <input type="text" name="rangka_plafon" value="<?php echo $r['rangka_plafon']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Tutup Plafon</label><br>
                                        <input type="text" name="tutup_plafon" value="<?php echo $r['tutup_plafon']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="">Status</label><br>
                                        <input type="text" name="status" value="<?php echo $r['status']; ?>" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
