...
<h5 class="text-center"> EDIT POSTINGAN</h5>
...
<div class="dropleft">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="?page=postingan">Bagian ini berfungsi memperbaharui postingan, <br> masukkan kode data rumah <br>
        yang ingin anda perbaiki!</a>
  </div> 
</div>
...
<p>
        <div class="form-group col-md-4"> 
            ...
            value="Simpan" class="btn btn-secondary">
        </div>
        </p>
